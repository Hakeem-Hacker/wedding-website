...
function myFunction() {
  var person = prompt("Marriage Month and Day is December, 29 ", "12/29");
  if (person != null) {
...
i  if (timeSpan <= -day) {
    timeLeft.innerHTML = 'Hope you had a nice weddng celebration!!'
    clearInterval(timerId)
    return
  }

  if (timeSpan <= 0) {
    timeLeft.innerHTML = 'Today is The D day.. Please make sure your present.!!'
    clearInterval(timerId)
    return
  }
